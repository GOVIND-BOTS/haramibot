...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001966336198"))
...
# You'll need a Pyrogram v2 String Session for these vars. Generate String from our session generator bot @YukkiStringBot
